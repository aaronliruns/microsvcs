package com.aaronliruns.microservices.demo;
...
@Configuration
@ComponentScan
@EntityScan("com.aaronliruns.microservices.demo.entity")
@EnableJpaRepositories("com.aaronliruns.microservices.demo.repository")
